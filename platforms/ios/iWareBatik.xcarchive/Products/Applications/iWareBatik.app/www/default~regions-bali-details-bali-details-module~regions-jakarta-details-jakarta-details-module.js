(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~regions-bali-details-bali-details-module~regions-jakarta-details-jakarta-details-module"],{
...
var DataService = /** @class */ (function () {
    function DataService(httpClient, http) {
        this.httpClient = httpClient;
        this.http = http;
        //
    }
    DataService.prototype.getDescription = function () {
        return this.http.get('https://iwarebatik.elearninglab.org/wp-json/wp/v2/batikdescription', {}, {});
        //return this.httpClient.get('https://iwarebatik.elearninglab.org/wp-json/wp/v2/batikdescription');
    };
    DataService.prototype.getBaliDescription = function () {
        return this.httpClient.get('https://iwarebatik.elearninglab.org/wp-json/wp/v2/regiondescription/?slug=bali');
    };
    DataService.prototype.getJakartaDescription = function () {
        return this.httpClient.get('https://iwarebatik.elearninglab.org/wp-json/wp/v2/regiondescription/?slug=jakarta');
    };
...
//# sourceMappingURL=default~regions-bali-details-bali-details-module~regions-jakarta-details-jakarta-details-module.js.map